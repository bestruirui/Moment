  ...
  for (var i = 0; i < data.length; i++) {
    ...
    result += `
      <li class="bb-list-li img-hide" id="${memo_id}">
        ...
        <div class="memos-zan"><emoji-reaction class="reactions" reactTargetId="/m/${memo_id}" theme="system" endpoint="https://emaction.bestrui.top" availableArrayString="👍,thumbs-up;🎉,party-popper;😄,smile-face;😎,cool;"></emoji-reaction></div>
...
function showTaglist() {
  ...
  // })
  // tagListDom += `<div class="memos-tag-all img-hide" onclick='getTagNow(this)'># 测试01</div>`
  // tagListDom += `<div class="memos-tag-all img-hide" onclick='getTagNow(this)'># 测试02</div>`
